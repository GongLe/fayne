            ...
            <ul class="ace-thumbnails">
                <li>
                    <a href="assets/images/gallery/image-1.jpg" title="Photo Title" data-rel="colorbox" class="cboxElement">
                        <img alt="150x150" src="${ctx}/static/ace/images/thumb-1.jpg">
                        <div class="tags">
                ...
                <li>
                    <a href="assets/images/gallery/image-2.jpg" data-rel="colorbox" class="cboxElement">
                        <img alt="150x150" src="${ctx}/static/ace/images/thumb-2.jpg">
                        <div class="text">
                    ...
                    <li>
                        <a href="assets/images/gallery/image-1.jpg" title="Photo Title" data-rel="colorbox" class="cboxElement">
                            <img alt="150x150" src="${ctx}/static/ace/images/thumb-3.jpg">
                            <div class="tags">
                                <span class="label label-info">breakfast</span>
                                <span class="label label-important">fruits</span>
                                <span class="label label-success">toast</span>
                    ...
                    <li>
                        <a href="assets/images/gallery/image-4.jpg" data-rel="colorbox" class="cboxElement">
                            <img alt="150x150" src="${ctx}/static/ace/images/thumb-4.jpg">
                            <div class="tags">
                    ...
                    <li>
                        <div>
                            <img alt="150x150" src="${ctx}/static/ace/images/thumb-5.jpg">
                            <div class="text">
                                <div class="inner">
                                    <span>Some Title!</span>

                                    <br>
                                    <a href="assets/images/gallery/image-5.jpg" data-rel="colorbox" class="cboxElement">
                    ...
                    <li>
                        <a href="assets/images/gallery/image-6.jpg" data-rel="colorbox" class="cboxElement">
                            <img alt="150x150" src="${ctx}/static/ace/images/thumb-6.jpg">
                        </a>
