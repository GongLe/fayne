 ...
 * <p/>
 * <p>
 * Invokes method {@link #start(String) start} for timing a task,
 * invokes method {@link #end() for stop timing} the corresponding task, the
 * start and end must match exactly.
 * </p>
 * <p/>
 * <p>
 * <b>Note</b>: Remember to {@link  org.fayne.utils.Stopwatchs#release() release} a stopwatch
 ...
 * <p/>
 *
 * @see org.fayne.utils.Stopwatchs.Stopwatch
 * @see #getTimingStat()
 */
...
public final class Stopwatchs {
     ...
     * @param taskTitle the specified task title
     * @return <ul>
     *         <li>{@link org.fayne.utils.Stopwatchs.Stopwatch#getElapsedTime() elapsed time} of the found
     *         task if it {@link org.fayne.utils.Stopwatchs.Stopwatch#isEnded() is ended}</li>
     *         <li>{@link System#currentTimeMillis() the current time} subtracts
     *         {@link org.fayne.utils.Stopwatchs.Stopwatch#startTime the start time} of the found task if it
     *         {@link org.fayne.utils.Stopwatchs.Stopwatch#isRunning() is running} </li>
